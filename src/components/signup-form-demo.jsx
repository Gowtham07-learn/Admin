...
import { Label } from "@acentrity/components/ui/label";
import { Input } from "@acentrity/components/ui/input";
...
export default function SignupFormDemo() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black-900">
      <div className="shadow-input w-full max-w-md rounded-none bg-white p-6 md:rounded-2xl md:p-8 dark:bg-black">
        <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200 text-center">
          Welcome to Admin Login
        </h2>
        <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300 text-center">
          Manage • Organize • Lead
        </p>
